...
<img
  src={bannerHeroImage}
  alt="Banner"
  className="w-[94%] h-[260px] sm:h-[340px] md:h-[420px] lg:h-[470px] xl:h-[500px] object-cover object-center"
/>

<div className="absolute inset-0 w-[94%] mx-auto flex items-center">
